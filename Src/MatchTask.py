...
class MatchTask:
    ...
    async def GetSignTask_Request(self, game_type):
        url = "https://api.live.bilibili.com/xlive/general-interface/v1/lpl-task/GetSignTask?game_type=" + str(
            game_type)
    ...
    async def GetShareTask_Request(self, game_type):
        url = "https://api.live.bilibili.com/xlive/general-interface/v1/lpl-task/GetShareTask?game_type=" + str(
            game_type)
    ...
    async def GetDanmuTask_Request(self, game_type):
        ...
        url = "https://api.live.bilibili.com/xlive/general-interface/v1/lpl-task/GetDanmuTask?game_type=" + str(
            game_type)
    ...
    async def GetCapsuleInfo_Request(self, id):
        url = "https://api.live.bilibili.com/xlive/web-ucenter/v1/capsule/get_capsule_info_v3?id=" + str(
            id) + "&from=web"
